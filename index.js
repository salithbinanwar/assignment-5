...
const displayDetails = name => {
    const mealLink = `https://www.themealdb.com/api/json/v1/1/lookup.php?i=${name}`;
    fetch(mealLink)
        .then(res => res.json())
        .then(data => {
...
const renderFoodInfo = food => {
    ...
    <img class="img-fluid rounded mb-2" src="${food.strMealThumb}" alt="">
    <h4>${food.strMeal}</h4>
...
function getFood(mealId) {
    const searchApi = `https://www.themealdb.com/api/json/v1/1/search.php?s=${mealId}`;
